...
@GenerateNiceMocks([MockSpec<FirebaseStorageService>(), MockSpec<EventFirestore>(), MockSpec<FirebaseFunctionCaller>(), MockSpec<NavigatorObserver>(), MockSpec<FirebaseAuthService>()])
void main() {}